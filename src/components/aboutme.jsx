...
const Aboutme = () => {
  return (
    <div className='aboutme-container'>
      <h2>
        When I'm taking a break from improving and refining my web development skills, I try to keep a good work-life balance. My favourite thing in the entire world is cats! I love them more than anything else. They bring me comfort even on the worst of days. I also love video games! My favourite being the Mass Effect Trilogy. Lastly, I love axe and knife throwing. Knife throwing is very therapeutic! So much so, I even have my own axe target in my backyard!
      </h2>
